    ...
    <div class="row fond" xmlns="http://www.w3.org/1999/html">
        ...
        <div class="col-md-11 fond">
            <div class="box box-primary fond" id="firstBox">
                ...
                <div id="textB" class="box-body ">
                    <div class="col-md-4 ">
                        <img src="{{ asset('css/images/xcsm.PNG') }}">
                ...
                @if(isset(Auth::user()->is_admin) && Auth::user()->is_admin==1)
                    <div class="box-footer fond">
                    <!-- Trigger the modal with a button -->
                    <button type="button" data-toggle="modal" data-target="#myModal" class="btn btn-sm bg-blue-active">
